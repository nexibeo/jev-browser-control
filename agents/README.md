...
```bash
claude mcp add -s user jev-browser -- npx -y https://jevbrowsercontrol.com/downloads/jev-browser-control-mcp-0.1.0.tgz
...
```bash
codex mcp add jev-browser -- npx -y https://jevbrowsercontrol.com/downloads/jev-browser-control-mcp-0.1.0.tgz
...
command = "npx"
args = ["-y", "https://jevbrowsercontrol.com/downloads/jev-browser-control-mcp-0.1.0.tgz"]
